...
Vector find_all_matches(uchar** image_1, uchar** image_2, int size_x, int size_y, ValuePoint* harris1, ValuePoint* harris2, int size_window, int size_patch, Match* match, int nbPoints1, int nbPoints2);
